// 06 - Média com forEach

// DESAFIO - Média - Calcular a média das notas entre as seguintes notas usando o forEach: 10, 6.5, 8, 7.5

const notas = [10, 6.5, 8, 7.5];
let somaDasNotas = 0;

// método de callback (função que chama outra função)
notas.forEach( nota => {
    somaDasNotas += nota;
})
...
console.log(media) // somou duas vezes o resultado da média...
