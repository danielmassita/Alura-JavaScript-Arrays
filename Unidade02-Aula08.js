// 08 - Concatenando Arrays e Dados
...
var lista1 = ['A', 'B'];
var lista2 = ['C', 'D'];
var novaLista = lista1.concat(lista2);
...
const listaOriginal = ["Maria", "Carlos", "Eduardo", "Samanta"];
const listaConcat = listaOriginal.concat("André", "Fernanda");
...
const listinhaOriginal = ["Maria", "Carlos", "Eduardo", "Samanta"]
const listinhaConcat = listinhaOriginal.concat(["André", "Fernanda"], ["Ricardo", "Ana"], ["Marcelo", "Bia"])

console.log(listinhaConcat)
console.log(listinhaOriginal);
...
let listonaOriginal = [50, 60, 70]
let listonaConcat = listonaOriginal.concat([80, [90, 100]])

console.log(listonaConcat);
console.log(listonaOriginal);
