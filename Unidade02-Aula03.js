...
var listaDeChamada = ['João', 'Ana', 'Caio', 'Lara', 'Marjorie', 'Leo'];
console.log(listaDeChamada)
console.log(`Lista de Chamada: ${listaDeChamada}`);

listaDeChamada.splice(1, 2, 'Rodrigo'); // Index que vai começar tirando [1], quantidade de elementos que serão removidos (2), novo elemento adicionado naquela posição 'Rodrigo'

console.log(listaDeChamada);
console.log(`Nova lista de Chamada: ${listaDeChamada}`);

listaDeChamada = ['João', 'Ana', 'Caio', 'Lara', 'Marjorie', 'Leo'];
console.log(listaDeChamada);
listaDeChamada.splice(2, 0, 'Rodrigo'); // Adicionando no index 2, sem remover nada 0, o novo elemento 'Rodrigo'

console.log(listaDeChamada);
console.log(`A mais nova lista de Chamada: ${listaDeChamada}`);
