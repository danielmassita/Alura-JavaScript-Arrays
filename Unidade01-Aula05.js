...
// Um professor adicionou acidentalmente apenas 3 notas de um aluno, então, como podemos adicionar um novo elemento na lista...

const notas = [10, 6, 8];
notas.push(7); // sempre vai inserir como último elemento...
console.log(notas);

let media = (notas[0] + notas[1] + notas[2] + notas[3])/notas.length;
console.log(media);

notas.push(); // vai inserir um valor UNDEFINED e a média será NaN...
