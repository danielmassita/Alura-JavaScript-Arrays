// 06 - DELETANDO ELEMENTOS

// Um professor adicionou acidentalmente uma nota excedente à lista de um aluno... Então devemos deletar pra corrigir removendo o último elemento...

let notas = [10, 7, 8, 5, 10]
console.log(notas);
notas.pop(); // Método .pop() que remove o último elemento != .push()
console.log(notas);
let media = (notas[0] + notas[1] + notas[2] + notas[3])/notas.length;

console.log(`A média é ${media}, somando as ${notas.length} notas dos respectivos bimestres.`)
