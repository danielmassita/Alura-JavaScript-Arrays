...
nomes.forEach(imprimeNomes); // O método .forEach(___, ___) aceita um segundo parâmetro, que será o índice (index), caso precise pegar um índice numério [0], [1], ... Para usar/alterar, etc. E o primeiro parâmetro poderá ser a função a ser chamada pra cada iteração...
