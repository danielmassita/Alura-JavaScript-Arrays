// 06 - LISTA COM DUAS DIMENSÕES

// Crie uma lista com os seguintes alunos 'João', 'Juliana', 'Caio', 'Ana' e crie uma lista com as seguintes notas 10, 8, 7.5, 9, por fim crie uma lista com 2 dimensões com os nomes e médias...

let nomeDosAlunos = ['João', 'Juliana', 'Caio', 'Ana'];
let notaDosAlunos = [10, 8, 7.5, 9];
console.log(nomeDosAlunos);
console.log(notaDosAlunos);

let listaDeNotasEAlunos = [nomeDosAlunos, notaDosAlunos];
console.log(listaDeNotasEAlunos[0][0]); // nome dos alunos - index 0 = João
console.log(listaDeNotasEAlunos[1][0]); // nota do aluno - index 0 = 10

console.log(`O(a) aluno(a) ${listaDeNotasEAlunos[0][0]} obteve a nota final de ${listaDeNotasEAlunos[1][0]}.`);
console.log(`O(a) aluno(a) ${listaDeNotasEAlunos[0][1]} obteve a nota final de ${listaDeNotasEAlunos[1][1]}.`);
console.log(`O(a) aluno(a) ${listaDeNotasEAlunos[0][2]} obteve a nota final de ${listaDeNotasEAlunos[1][2]}.`);
console.log(`O(a) aluno(a) ${listaDeNotasEAlunos[0][3]} obteve a nota final de ${listaDeNotasEAlunos[1][3]}.`);

console.log(' ');

for(i = 0; i<4; i++) {
    console.log(`O(a) aluno(a) ${listaDeNotasEAlunos[0][i]} obteve a nota final de ${listaDeNotasEAlunos[1][i]}.`)
}
