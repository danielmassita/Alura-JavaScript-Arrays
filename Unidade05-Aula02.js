// 02 - Filtrando Elementos da Array

// DESAFIO - Filtrando por Nota - Depois de calcular a média dos alunos, precisamos mostrar quem está reprovado entre os alunos. ['Ana', 'Marcos', 'Maria', 'Mauro'] e [7, 4.5, 8, 7.5]. 

const nomes = ['Ana', 'Marcos', 'Maria', 'Mauro'];
const notas = [7, 4.5, 8, 7.5];

// O método .filter retorna um boolean (true/false)

const reprovados = nomes.filter( (aluno, indice) => notas[indice] < 5);
// const reprovados = nomes.filter( (_, indice) => notas[indice] < 5);
// Não estamos usando o "aluno" na função, então podemos substituir por _.

console.log(`Reprovados: ${reprovados}.`);

const aprovados = nomes.filter( (_, index) => notas[index] >= 5)
